...
@router.post("/payments/checkout", response_model=PaymentResponse, status_code=status.HTTP_200_OK)
...
@router.get("/payments/{payment_id}", response_model=PaymentResponse, status_code=status.HTTP_200_OK)
